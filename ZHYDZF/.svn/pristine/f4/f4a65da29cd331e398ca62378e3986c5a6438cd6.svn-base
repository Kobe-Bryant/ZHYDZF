//
//  ZhiBanAnPaiViewController.m
//  BoandaProject
//
//  Created by 李凌辉 on 14-7-2.
//  Copyright (c) 2014年 szboanda. All rights reserved.
//http://61.164.73.82:8090/zhbg/invoke?version=1.15&imei=10:DD:B1:BC:2E:AE&clientType=IPAD&userid=leying&password=123456&service=ZBB_LIST&P_PAGESIZE=25
//http://61.164.73.82:8090/ydzf/invoke?version=1.15&imei=10:DD:B1:BC:2E:AE&clientType=IPAD&userid=leying&password=123456&service=ZBB_LIST&P_PAGESIZE=25
//http://61.164.73.82:8090/zhbg/invoke?version=1.15&imei=10:DD:B1:BC:2E:AE&clientType=IPAD&userid=leying&password=123456&service=GZDTNR_LIST&wzbh=22a66930-e296-4764-b9dc-424eb3686df1&P_PAGESIZE=25
#import "ZhiBanAnPaiViewController.h"
#import "ServiceUrlString.h"
#import "PDJsonkit.h"
#import "GZDTDetailViewController.h"

@interface ZhiBanAnPaiViewController ()
...
@implementation ZhiBanAnPaiViewController
...
- (void)searchClick{
    ...
    [params setObject:@"ZBB_LIST" forKey:@"service"];
