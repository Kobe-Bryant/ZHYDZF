...
@interface BuildProjectViewController ()
@property (nonatomic, assign) NSInteger currentTag;
@property (nonatomic, strong) UIPopoverController *popController;
@end

@implementation BuildProjectViewController
...
- (NSDictionary *)getValue{
    ...
    [valueDict setValue:[NSString stringWithFormat:@"%d",self.isApproval] forKey:@"XMSP"];
