...
-(void)setupItems{
    NSArray *array = [NSArray arrayWithObjects:@"gufei.png",@"gelu.png",@"yancong.png",@"feiqi.png" ,@"noise.png",@"air.png",@"water.png",@"sub.png",@"biao.png",@"rain.png",@"paikou.png",@"radio.png",@"danger.png",@"road_p.png",@"road_l.png",@"river_l.png",@"river_p.png",@"pipe_p.png",@"pipe_l.png",@"compass.png",nil];
    NSArray *array1 = [NSArray arrayWithObjects:@"固废",@"锅炉",@"烟囱",@"废气",@"噪声排放源",@"废气处理设施",@"废水处理设施",@"总排口",@"标排口",@"雨水排口",@"排口",@"辐射源",@"危险废物",@"道路",@"道路",@"河流",@"河流",@"水管",@"水管",@"指南针", nil];
    NSMutableArray *tmpArray = [NSMutableArray arrayWithCapacity:35];
    for (int i = 0; i < [array count]; i++) {
        CustomIconItem *item = [[CustomIconItem alloc] initWithWithImg:[array objectAtIndex:i] andTitle:[array1 objectAtIndex:i]];
